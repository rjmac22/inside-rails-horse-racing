#!/usr/bin/env python3
"""Promote the exact validated Inside Rails Database v2 candidate."""
...
from inside_rails.database.release_v2 import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=f"Exact validated v2 candidate (default: {DEFAULT_CANDIDATE})",
    )
    parser.add_argument(
        "--release",
        type=Path,
        default=DEFAULT_RELEASE,
        help=f"Canonical immutable v2 release path (default: {DEFAULT_RELEASE})",
    )
    parser.add_argument(
        "--base-release",
        type=Path,
        default=DEFAULT_BASE_RELEASE,
        help=f"Retained accepted v1 base release (default: {DEFAULT_BASE_RELEASE})",
    )
    parser.add_argument(
        "--promotion-commit",
        default=None,
...
def main() -> None:
    args = parse_args()
    summary = promote_inside_rails_v2(
        args.candidate,
        args.release,
        project_root=ROOT,
