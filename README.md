# Inside Rails: UK & Ireland Horse-Racing Database

A notebook-led data-engineering and database-design portfolio project using historical UK and Irish horse-racing results.
...
The next stage is Notebook 01: structural profiling of the supplied `raceform.db` source database.
